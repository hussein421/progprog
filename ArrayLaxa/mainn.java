...
public class mainn {
	...
	public static void main(String[] args) {
		arrayMetoder sc= new arrayMetoder();
		...
		System.out.println(sc.upg2(names));
		System.out.println(sc.upg4(names));
		System.out.println(sc.upg5(numbers));
		System.out.println(sc.upg6(names));
	}
